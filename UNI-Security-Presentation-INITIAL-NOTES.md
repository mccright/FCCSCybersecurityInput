...
Financial Services Sector "Cybersecurity Profile:" https://www.fsscc.org/Financial-Sector-Cybersecurity-Profile [280 "diagnostic statements"]
  ...
  (browser, mobile device, phone, and surface mail)

Need to reduce membership in this group so we can use it for the 'access all source code repos' mission.  The implementation team apparently was uncomfortable with the membership of this group.

Email-enabled AD group to control access to Static Code Security Analysis resources and to simplify emailing to the ISR SCSA team members

Email-enabled AD group to control access to BULK source code - limited to full time ISR SCSA team members
...
This is a material challenge as Principal extends its business & supporting technology operations into a diverse and expanding ecosystem of Internet-enabled platforms and services.

Deloitte has worked for the past 2 years with the Financial Services Information Sharing and Analysis Center (FS-ISAC) to survey members on how they are confronting these cyber challenges.  Principal is an FSISAC member.
...
at all costs." (p. 3, https://principalworkplace.sharepoint.com/sites/intranet/bu/Risk/Documents/Enterprise%20Risk%20Mgmt/ERM%20Booklet.pdf)
...
• Regulators demand it.
• Rating agencies look for it.
( p. 5, https://principalworkplace.sharepoint.com/sites/intranet/bu/Risk/Documents/Enterprise%20Risk%20Mgmt/ERM%20Booklet.pdf)
...
c. Strategic risk
(p. 6, https://principalworkplace.sharepoint.com/sites/intranet/bu/Risk/Documents/Enterprise%20Risk%20Mgmt/ERM%20Booklet.pdf and p. 1, https://inside.theprincipal.net/gfr/docs/riskmanagementatpfg.pdf)
...
M:\My-Documents\Architecture\Requirements-Diagrams-Chapter-15-Conclusion-Figures.pptx
